...
async function seed() {
  ...
  try {
    ...
    const projectData = {
      ...
      hero_image_url: 'https://storage.propfyndr.com/projects/aims-max-gardenia-golf-city/hero.jpg',
    ...
    await prisma.projectDocument.create({
      data: {
        ...
        storage_url: "https://storage.propfyndr.com/documents/aims-max-gardenia-golf-city-brochure.pdf",
        doc_type: "brochure",
    ...
    await prisma.projectImage.create({
      data: {
        project_id: project.id,
        url: "https://storage.propfyndr.com/projects/aims-max-gardenia-golf-city/hero.jpg",
        type: "hero"
      }
    })
