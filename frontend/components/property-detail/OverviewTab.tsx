...
export default function OverviewTab({
  ...
  // Hero already shows the tagline — only render this card when there's real
  ...
  const stats = [
    ...
    { label: 'Land Area', value: d?.land_area_acres ? `${d.land_area_acres} Ac` : '—' },
    { label: 'Launch', value: d?.launch_date ? new Date(d.launch_date).toLocaleDateString('en-IN', { month: 'short', year: 'numeric' }) : '—' },
    { label: 'Possession', value: d?.possession_label ?? '—' },
  ]
