    ...
    <div className="space-y-4">
      ...
      <div className="w-full">
        <div
          ...
          className="grid grid-cols-3 lg:grid-cols-6 gap-1 p-1 bg-gray-100 dark:bg-slate-700 rounded-lg"
        >
          {TABS.map((tab) => {
              ...
              <button
                ...
                className={`flex items-center justify-center gap-1 px-2 py-2 rounded-md transition-colors ${
                  isActive
                    ...
                    : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-white/60 dark:hover:bg-slate-600'
                }`}
              >
                {tab.icon}
      ...
      {isAdmin && (
        <div className="pt-4 border-t dark:border-slate-700 flex gap-2">
          <button className="px-3 py-1.5 text-xs bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-400 rounded hover:bg-blue-200 dark:hover:bg-blue-900 transition-colors">
            Edit Intelligence
          </button>
          <button className="px-3 py-1.5 text-xs bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors">
            Regenerate
          </button>
        </div>
      )}
