    ...
    <AnimatePresence mode="wait">
      ...
      >
        <m.div
          ...
          className="w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-700/50 shadow-2xl overflow-hidden pb-safe relative"
        >
            ...
            {!submittedSuccess ? (
              <>
                ...
                <div className="space-y-4 mb-5">
                  {/* Name Input */}
                  <div>
                    <label className="text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide block mb-2">
                      Full Name
                    </label>
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 dark:focus:ring-emerald-400/30 focus:border-emerald-400 dark:focus:border-emerald-500 transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative flex items-center">
                      <div className="absolute left-3.5 flex items-center gap-1.5 pointer-events-none text-slate-400 text-xs font-semibold">
                      ...
                      <input
                        ...
                        className="w-full pl-16 pr-4 py-3 bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 dark:focus:ring-emerald-400/30 focus:border-emerald-400 dark:focus:border-emerald-500 transition-all font-mono tracking-wide"
                      />
                    </div>
                  </div>
                        ...
                        <button
                          ...
                          className={`px-3.5 py-2 rounded-lg text-xs font-semibold transition-all border ${
                            loanStatus === status
                              ...
                              : 'bg-slate-50 dark:bg-slate-800/30 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800/60'
                          }`}
                        >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-1 p-1 rounded-xl bg-slate-100 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700">
                      {(
                        [
                        ...
                        <button
                          ...
                          className={`py-2 px-2 text-xs font-semibold rounded-lg transition-all text-center ${
                            intentTier === item.id
                              ? 'bg-white dark:bg-slate-700 text-slate-900 dark:text-white shadow-sm border border-emerald-200 dark:border-emerald-600'
                ...
                {/* Consent Checkbox */}
                <div className="mb-5 flex items-start gap-2.5 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200/50 dark:border-emerald-800/50">
                  <input
                    type="checkbox"
                    id="consent"
                  ...
                  />
                  <label htmlFor="consent" className="text-xs text-emerald-900 dark:text-emerald-100 cursor-pointer flex-1 leading-relaxed">
                    I authorize RealtyPals to share my requirements with the developer for <span className="font-semibold">{project?.name}</span>
                  </label>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 text-white disabled:bg-slate-200 disabled:text-slate-400 dark:disabled:bg-slate-800 dark:disabled:text-slate-600 font-semibold rounded-xl transition-all duration-200 text-sm shadow-lg hover:shadow-xl active:scale-[0.98] flex items-center justify-center gap-2"
                >
                  {submitting ? (
                    <>
